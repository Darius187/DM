...
${technik}` : ''}${tipFehlt}` }, () => this.rtsBaue(b));
  ...
  private baueDevTabs(): DKTab[] {
    ...
    return [
      ...
      { name: 'ANFANG', controls: () => {
        ...
        cs.push({ kind: 'note', text: 'Gemalter Held V2.2: 8 Richtungen mit Stand, 24 ruhigen Gehphasen, 6 Schwertphasen und Block. Andere Waffenklassen bleiben bis zu eigenen Vollblaettern in der Zeichnung.' });
  ...
  protected override spielerTiefe(): number {
    ...
    return this.py + this.heldUnterkante();
  }
