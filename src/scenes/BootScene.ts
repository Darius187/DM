...
export class BootScene extends Phaser.Scene {
  ...
  private finish(): void {
    ...
    const ziel = prolog === 'abstieg' ? 'Treppenabstieg' : prolog === 'nebel' ? 'NebelProbe' : prolog === 'treppe' ? 'TreppenProbe' : prolog === 'blutstrom' ? 'BlutstromGang' : prolog === 'schwelle' ? 'DieSchwelle' : prolog === 'kammer' || prolog === '1' ? 'KammerDerFinsternis' : 'Title';
