...
export const RTS_UNIT_TYP: Record<RtsUnitTyp, RtsUnitDef> = {
  ...
  e_golem:  { name: 'Fleischgolem', team: 'feind', hp: 3000, dmg: 52, reich: 48, speed: 30, rank: 0, figur: 'golem', heiler: false, schadensRed: 0.5, schild: false, schadensArt: 'wucht', tags: ['faul', 'ungepanzert', 'schwer'] },
};
