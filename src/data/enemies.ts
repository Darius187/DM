...
export const ENEMIES: Readonly<Record<EnemyTypeId, EnemyDef>> = {
  ...
  templer: {
    name: 'Der Tempelritter', hpBase: 340, hpPerDepth: 70, dmgBase: 17, dmgPerDepth: 4,
    speedMin: 66, speedMax: 66, r: 20, col: '#6a6258', xpBase: 300, xpPerDepth: 0, aggro: 900, boss: true,
  },
