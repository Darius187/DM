...
$pageDescription = 'Erklärung zur digitalen Barrierefreiheit von unisilent.de nach WCAG 2.1 AA.';
render('pages/barrierefreiheit', compact('pageTitle', 'pageDescription'));
