<footer class="bg-brand-900 text-brand-100 mt-16">
  <div class="container-x py-12 grid gap-10 md:grid-cols-4">
    <div class="md:col-span-2">
      <div class="flex items-center gap-3">
        <span class="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white text-brand-900 font-bold text-lg" aria-hidden="true">u</span>
      ...
      <address class="mt-6 not-italic text-sm text-brand-200 leading-relaxed">
        ...
        <span class="block mt-3">
          Telefon: <a href="tel:+4977203041933" class="text-white hover:text-accent-500 no-underline">+49 (0)7720 3041933</a><br>
          E-Mail: <a href="mailto:info@db-bas.de" class="text-white hover:text-accent-500 no-underline">info@db-bas.de</a>
        </span>
      </address>
    </div>

    <div>
      <h2 class="text-white font-semibold text-sm uppercase tracking-wider">Produkte</h2>
      <ul class="mt-4 space-y-2 text-sm">
        ...
        <li><a href="/produkte"             class="font-medium text-white hover:text-accent-500 no-underline">Alle Produkte →</a></li>
      </ul>
    </div>
