  ...
  <div class="container-x py-16 md:py-24 lg:py-28 grid md:grid-cols-2 gap-12 items-center">
    <div class="animate-fade-in-up">
      ...
      <ul class="mt-10 grid grid-cols-3 gap-6 text-center max-w-md">
        <li><div class="text-3xl font-bold text-white">300<span class="text-accent-500">kg</span></div><div class="text-xs text-brand-200 uppercase tracking-wider">max. Tragkraft</div></li>
        <li><div class="text-3xl font-bold text-white">5<span class="text-accent-500">″</span></div><div class="text-xs text-brand-200 uppercase tracking-wider">leise Räder</div></li>
        <li><div class="text-3xl font-bold text-white">7<span class="text-accent-500"></span></div><div class="text-xs text-brand-200 uppercase tracking-wider">Modelle</div></li>
      </ul>
    </div>
    <div class="relative hidden md:block">
      <div class="absolute -inset-8 bg-accent-500/20 blur-3xl rounded-full" aria-hidden="true"></div>
      <picture>
        <source type="image/webp" srcset="/images/products/PLA300-DX/main-01-800.webp 800w, /images/products/PLA300-DX/main-01-1600.webp 1600w" sizes="(min-width:1024px) 50vw, 100vw">
        <img src="/images/products/PLA300-DX/main-01-800.jpg" alt="Plattformwagen PLA300-DX in blau, aufgestellt mit klappbarem Griff" class="relative drop-shadow-2xl mx-auto" loading="eager" fetchpriority="high" width="800" height="800">
      </picture>
    </div>
  </div>
</section>
  ...
  <div class="container-x">
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="text-center md:text-left">
        ...
        <h3 class="mt-4">Direkt vom Lieferant</h3>
        <p class="mt-2 text-slate-600">B2B-Stückzahlpreise auf Anfrage. Versand aus Villingen-Schwenningen, kurze Lieferzeiten in der EU.</p>
      </div>
    </div>
  </div>
</section>
